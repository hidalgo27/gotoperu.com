<nav class="nav nav-pills nav-fill nav-goto navbar-expand-lg d-none d-md-flex" id="content-page">
    ...
    <a class="nav-item nav-link text-g-dark font-weight-normal border-primary" href="{{route('packages_path')}}">TOURS PACKAGES</a>
    <a class="nav-item nav-link text-g-dark font-weight-normal border-g-green" href="{{route('destinations_path')}}">DESTINATIONS</a>
    <a class="nav-item nav-link text-g-dark font-weight-normal border-danger {{ Request::is( 'about-us') ? 'active' : '' }}" href="{{route('about_path')}}">ABOUT US</a>
    <a class="nav-item nav-link text-g-dark font-weight-normal border-success" href="{{route('faq_path')}}">FAQ</a>
    <a class="nav-item nav-link text-g-dark font-weight-normal border-g-yellow" href="{{route('testimonials_path')}}">TESTIMONIALS</a>
