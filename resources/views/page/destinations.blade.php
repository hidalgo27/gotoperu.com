                                ...
                                <div class="col-md-4 col-sm-6 mb-4">
                                    <div class="grid-category position-relative shadow-sm">
                                        <a href="{{route('destinations_country_show_path', ['peru-travel', str_replace(' ', '-', strtolower($destino->nombre))])}}-tours" class="text-g-dark rounded">
                                            <img data-src="{{asset('images/destinations/'.str_replace(' ', '-', strtolower($destino->imagen)).'')}}" data-srcset="{{asset('images/destinations/destinations/'.str_replace(' ', '-', strtolower($destino->imagen)).'')}}" alt="Machu Picchu" class="w-100 rounded lazy has-webp">
