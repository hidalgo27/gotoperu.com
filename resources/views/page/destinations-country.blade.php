        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    ...
                    <div class="card p-1">
                        <a href="{{route('destinations_country_show_path', ['peru-travel', 'arequipa-tours' ])}}"><i class="fa fa-chevron-right mb-2"></i>Arequipa <span class="badge badge-g-yellow float-right mt-1">4</span></a>
                        </a>
