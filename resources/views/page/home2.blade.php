    ...
    <section class="header-video d-none d-md-block chat-mensajes">
            ...
            <div class="container-fluid">
                <div class="row align-items-center justify-content-between my-2">
                    ...
                    <div class="col text-center">
                        <h5 class="font-weight-light"><b>GO</b> with the Peruvian experts</h5>
                    </div>
        ...
        <div id="overlay" class="position-relative">
            <video class="hero-vid-home" id="hero-vid" poster="{{asset('images/slider/package-1.webp')}}" autoplay loop muted>
                <source src="{{asset('media/gotoperu.mp4')}}" />
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col-12">
                            <div class="nav nav-pills flex-column flex-sm-row" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="flex-sm-fill text-sm-center nav-link active" id="recommended-tab" data-toggle="pill" href="#recommended" role="tab" aria-controls="recommended" aria-selected="true">Recommended</a>
                                <a class="flex-sm-fill text-sm-center nav-link" id="all-tab" data-toggle="pill" href="#all" role="tab" aria-controls="all" aria-selected="false">All Included</a>
                                <a class="flex-sm-fill text-sm-center nav-link" id="families-tab" data-toggle="pill" href="#families" role="tab" aria-controls="families" aria-selected="false">For Families</a>
                                <a class="flex-sm-fill text-sm-center nav-link" id="romantic-tab" data-toggle="pill" href="#romantic" role="tab" aria-controls="romantic" aria-selected="false">Settings</a>
                            </div>
                        </div>
                        <div class="col-9">
    ...
    <section class="bg-white">
        <div class="container">
            <div class="row pt-md-0 pt-sm-0 pt-0 pt-lg-5 pb-2">
                <div class="col">
                    <h1 class="text-secondary font-weight-bold h4"><strong>PERU TRAVEL PACKAGES</strong> <small class="font-italic text-primary font-weight-bold">(Land Packages)</small></h1>
                    {{--<h2 class="text-g-green">GREAT ADVENTURE <strong>PACKAGES</strong> FOR EVERYONE WITH GOTOPERU</h2>--}}
                    {{--<h2 class="text-g-green h3 font-weight-light">THE BEST <strong>PERU VACATIONS</strong> AND <strong>MACHU PICCHU TOURS</strong></h2>--}}
                    {{--<p class="h4 font-weight-light">Offering you an authentic and reliable <strong>travel experience</strong> in peru welcoming you to explore the many fully <strong>Customized Travel Packages</strong> we have that suit every budget. let us plan your unforgettable <strong>trip</strong> to our majestic <strong>Machu Picchu</strong> and the rest of our  homeland… Peru!</p>--}}
